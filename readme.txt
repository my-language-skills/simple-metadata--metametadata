...
This plugin provides the ability to have one metabox with the meta metadata schema properties.
...
1. Upload the plugin files to the `/wp-content/plugins/simple-metadata-metametadata` directory, or install the plugin
...
The Simple metadata metametadata is supplied "as is" and all use is at your own risk.
